...
This private study repository maintains programming assignments for the University of Michigan Winter 2022 course.
...
| A2 | Linear classifiers; two-layer network | Not started |
| A3 | Modular API; CNN; BatchNorm; Autograd | Not started |
...
CPU tests cover A1 tensor exercises, all three kNN distance implementations, voting, the classifier, and cross-validation. The CUDA-only test is skipped when no NVIDIA GPU is available. CIFAR-10 accuracy cells should still be run from the course notebook.
